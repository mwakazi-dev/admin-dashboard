        ...
        switch (_a.label) {
            case 0:
                ...
                mailOptions = {
                    ...
                    html: "<p>Your verification code is <strong>".concat(otp, "</strong>. It expires in 10 minutes.</p>"),
                };
...
var sendPasswordResetLink = function (email, resetURL) { return __awaiter(void 0, void 0, void 0, function () {
    var transporter, mailOptions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                mailOptions = {
                    ...
                    html: "<p>Click <a href=\"".concat(resetURL, "\">here</a> to reset your password.</p>"),
                };
                return [4 /*yield*/, transporter.sendMail(mailOptions)];
            case 1:
                _a.sent();
